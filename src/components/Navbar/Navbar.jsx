...
function Navbar() {
  ...
  <div className="container-fluid">
    <Link className="navbar-brand" to="/">Core-Redux</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className="nav-link active" aria-current="page" to="/AllProducts">All-Products</Link>
        </li>
      ...
      <form className="d-flex">
        ...
        <button className="btn btn-outline-info mx-2 " type="submit">Cart_{cartProducts.length}</button>
